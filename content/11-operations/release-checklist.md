...
- [ ] README 和网页把 code line、Stable、Preview 分开说明；本任务事实中的 Latest Stable 是 `v0.1.2` `[待复核]`，未提供的 code line / Preview 不得臆造；
...
- [ ] Official Runtime staging 明确记录为 `NOT_READY` 或经事实确认的状态；staging 未就绪时不得把 smoke 子集写成完整安装验收；
